...
const PRICE_RANGE_IDS = new Set<PriceRangeId>([
  "under-5",
  "5-10",
  "10-15",
  "15-plus",
]);
const SORT_IDS = new Set<ProductSortId>(
  PRODUCT_SORT_OPTIONS.map((option) => option.id),
);
...
export function parseListingQueryState(
  url: URL,
...
export function applyListingQueryToUrl(
  url: URL,
